...
<x-app-layout>
    {{-- Set warna brand di CSS (fallback aman); bisa override di layouts/app.blade.php --}}
    <style>
        :root {
            --brand-red: #D21F26;
            --brand-blue: #145EFC;
    ...
    <section class="relative overflow-hidden bg-white">
        ...
        {{-- Top accent: MERAH lalu BIRU (tanpa gradient) --}}
        <div class="w-full">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16">
            ...
            <header class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 items-start">
                <div class="lg:col-span-2">
                    <p class="text-xs sm:text-sm font-semibold tracking-wide uppercase"
                        style="color: var(--brand-red);">Hubungi Kami</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div class="rounded-xl bg-white ring-1 ring-gray-200 p-5 sm:p-6 shadow-sm">
                        <div class="flex items-start gap-3">
                            <div class="grid h-11 w-11 place-items-center rounded-xl text-white"
                    ...
                    <div class="lg:col-span-3">
                        <form
                            ...
                            <p id="contact-form-help" class="mt-3 text-xs sm:text-sm text-gray-500">
                                ...
                                <a class="hover:underline" style="color: var(--brand-blue)" href="{{ url('/privacy') }}">Kebijakan Privasi</a>.
                            </p>
                    ...
                    <aside class="lg:col-span-2 space-y-6">
                        <div class="rounded-xl bg-white ring-1 ring-gray-200 p-5 sm:p-6 shadow-sm">
                            ...
                            <ul class="mt-3 space-y-2 text-sm sm:text-base text-gray-700">
                                <li class="flex items-center justify-between"><span>Senin–Jumat</span><span class="font-semibold" style="color: var(--brand-blue)">09.00–17.00</span></li>
                                <li class="flex items-center justify-between"><span>Sabtu</span><span class="font-semibold" style="color: var(--brand-blue)">10.00–14.00</span></li>
                                <li class="flex items-center justify-between"><span>Minggu/Libur</span><span class="font-semibold" style="color: var(--brand-red)">Tutup</span></li>
                            </ul>
                        </div>
