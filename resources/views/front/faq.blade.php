        ...
        <div class="mx-auto max-w-7xl px-6 py-12">
            ...
            <header class="max-w-3xl">
                ...
                <div class="mt-4 flex gap-1">
                    <span class="inline-block h-1 w-16 rounded-full" style="background-color:#D21F26"></span>
                    <span class="inline-block h-1 w-16 rounded-full" style="background-color:#145EFC"></span>
                </div>
            </header>
                    ...
                    <div class="sm:col-span-8">
                        <div class="relative h-11">
                            <input
                                id="faqSearch"
                                type="search"
                                class="h-11 w-full rounded-full border border-gray-200 bg-white pl-12 pr-36 text-sm sm:text-base focus:border-[#145EFC] focus:ring-[#145EFC] focus-ring focus-ring:focus"
                    ...
                    <div class="sm:col-span-4">
                        <div class="flex w-full justify-start sm:justify-end gap-2">
                            <button id="btnOpenAll"
                                ...
                                style="background-color:#D21F26; color:#fff">
                                Buka Semua
                            </button>
                    ...
                    <summary class="flex items-center justify-between gap-4 cursor-pointer px-4 py-4">
                        <span class="flex min-w-0 items-start gap-3">
                            ...
                            <span class="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-full text-white"
                                style="background-color:#D21F26">?</span>
                        ...
                        <span class="flex items-center gap-2">
                            ...
                            <button type="button"
                                ...
                                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="#145EFC" aria-hidden="true">
            ...
            <div id="emptyState"
                ...
                <p class="mt-1 text-sm text-gray-600">
                    ...
                    <a href="{{ route('contact') }}" class="font-medium" style="color:#145EFC">hubungi kami</a>.
                </p>
            </div>

            {{-- CTA (tanpa gradient: merah → biru via dua tombol) --}}
